...
import { sunCareProducts } from '../data/sunCareProducts';
import ProductCard from '../components/ProductCard';

const CATEGORIES = ['All', 'Face', 'Body', 'Kids'];
const SORT_OPTIONS = ['Featured', 'Price: Low to High', 'Price: High to Low', 'Highest Rated', 'Newest'];

function SunCarePage() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    switch (sortBy) {
      ...
      case 'Highest Rated':
        ...
        break;
      case 'Newest':
        // Mock sorting by newest - just reversing for now
        products.reverse();
        break;
      default:
        // 'Featured' - do nothing as they are already ordered
        break;
    }
  ...
  return (
    <div className="face-care-page page-transition">
      <div className="page-hero">
        <h1 className="page-title">SUN CARE</h1>
        <p className="page-subtitle">Protect and nourish your skin under the sun.</p>
      </div>
