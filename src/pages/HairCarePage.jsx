...
const CATEGORIES = ['All', 'Shampoos', 'Conditioners & Masks', 'Hair Serums', 'Hair Creams', 'Hair Mists', 'Hair Loss Treatment'];
  ...
  return (
    <div className="face-care-page page-transition">
      <div className="page-hero">
        <h1 className="page-title">HAIR CARE</h1>
        <p className="page-subtitle">Elevate your hair care ritual.</p>
      </div>
